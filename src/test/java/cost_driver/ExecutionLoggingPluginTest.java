...
//            var pause = e.getCause().getClass().getSimpleName();
    ...
    @Test
    @DisplayName("Junit - Find Concrete Cost Driver")
    void testFindConcreteCaseByCost() throws ScyllaValidationException {
        CostDriverExecutionLoggingPlugin testSubject = new CostDriverExecutionLoggingPlugin();

        //Prepare the GlobalConfig
        prepareGlobalConfig();
...
//            var pause = e.getCause().getClass().getSimpleName();
    ...
    private void prepareGlobalConfig() {
        ...
        // Instantiate a testGlobalConfig
        TEST_GLOBAL_CONFIG = new GlobalConfiguration(testID, testZoneId, testNotRandomSeed, testResources, testEventOrderTypes);

    }

    private void prepareDrivers() throws ScyllaValidationException {
        AbstractCostDriver ACD_1 = new AbstractCostDriver("Delivery", CONCRETE_DRIVERS_1);
        ...
        AbstractCostDriver ACD_2 = new AbstractCostDriver("Filling Material", CONCRETE_DRIVERS_2);
        ConcreteCostDriver CCD_2_1 = new ConcreteCostDriver("Filling_A", ACD_2, 0.00001468);
        ACD_2.addChild(CCD_2_1);

        // Add ACDs in the list.
        TEST_ABSTRACT_DRIVER_LIST.add(ACD_1);
        TEST_ABSTRACT_DRIVER_LIST.add(ACD_2);

        // Put the ACDs in the GlobalConfiguration
        TEST_GLOBAL_CONFIG.getExtensionAttributes().put("cost_driver_costDrivers", TEST_ABSTRACT_DRIVER_LIST);
