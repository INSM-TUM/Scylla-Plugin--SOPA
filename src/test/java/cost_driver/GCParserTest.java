...
class GCParserTest {
    ...
    private List<AbstractCostDriver> initialiseDriver() throws ScyllaValidationException {
        ...
        AbstractCostDriver ACD_1 = new AbstractCostDriver("Delivery", testConcreteCostDriver1, TimeUnit.HOURS);
        ...
        AbstractCostDriver ACD_2 = new AbstractCostDriver("Filling Material", testConcreteCostDriver2, TimeUnit.HOURS);
        ConcreteCostDriver CCD_2_1 = new ConcreteCostDriver("Filling_A", ACD_2, 0.00001468);
        ACD_2.addChild(CCD_2_1);
        AbstractCostDriver ACD_3 = new AbstractCostDriver("Packaging Material", testConcreteCostDriver3, TimeUnit.HOURS);
        ...
        AbstractCostDriver ACD_4 = new AbstractCostDriver("Re-Routing", testConcreteCostDriver4, TimeUnit.HOURS);
        ...
        AbstractCostDriver ACD_5 = new AbstractCostDriver("Receipt", testConcreteCostDriver5, TimeUnit.HOURS);
        ConcreteCostDriver CCD_5_1 = new ConcreteCostDriver("Receipt", ACD_5, 0.00001153);
        ACD_5.addChild(CCD_5_1);
        AbstractCostDriver ACD_6 = new AbstractCostDriver("Shipment", testConcreteCostDriver6, TimeUnit.HOURS);
